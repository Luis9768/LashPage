...
export default function LocationView({ onBack }) {
  ...
  return (
    <div className={`min-h-screen pb-24 transition-colors duration-300 ${
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-8">
        <div className={`rounded-3xl overflow-hidden border p-3 ${
          isDark ? 'bg-[#0d0d11] border-[#22222a]' : 'bg-white border-rose-100 shadow-md'
        }`}>
          <iframe
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className={`p-5 rounded-2xl border ${
          isDark ? 'bg-[#0d0d11] border-[#22222a]' : 'bg-white border-rose-100 shadow-sm'
        }`}>
